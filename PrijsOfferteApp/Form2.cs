...
namespace PrijsOfferteApp
{
    public partial class Form2 : Form
    {
        ...
        public void GeneratePdf()
        {
            ...
            BaseColor gris = new BaseColor(224, 224, 224);
            BaseColor blanc = new BaseColor(255, 255, 255);


            Font info_style = new Font(iTextSharp.text.Font.FontFamily.HELVETICA, 10f, iTextSharp.text.Font.NORMAL, BaseColor.GRAY);

            Font title_style = new Font(iTextSharp.text.Font.FontFamily.HELVETICA, 15f, iTextSharp.text.Font.BOLD, BaseColor.GRAY);
